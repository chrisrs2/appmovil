...
class Pipe(Widget):
    # atributos numericos
    GAP_SIZE = NumericProperty(100) # altura de los tubos
    CAP_SIZE = NumericProperty(20) # altura de la cabeza del tubo
    ...
    def __init__(self, **kwargs):
        ...
        self.pipe_body_texture = Image(source="tuberia.png").texture
